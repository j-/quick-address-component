...
export const getEntitiesFromQASResult = (queryId: string, result: AddressSearchResults): HasAddressEntities & HasQueryResultEntities => {
  const entities: HasAddressEntities & HasQueryResultEntities = {
    addresses: {},
    queryResults: {},
  };
