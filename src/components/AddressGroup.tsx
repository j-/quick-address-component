...
const AddressGroup: React.FC<Props> = () => {
  ...
  return (
    <div className="AddressGroup">
      <div className="AddressGroup-suggest-container">
        <div className="AddressGroup-line-1-container form-group">
          <label htmlFor={id('AddressGroup-line-1')}>Address line 1</label><br />
          <input
            id={id('AddressGroup-line-1')}
            ref={addressLine1Ref}
        ...
        {showSuggestions && (
          <div className="AddressGroup-suggest-results ml-2 mr-2 mt-n1" ref={resultsRef}>
